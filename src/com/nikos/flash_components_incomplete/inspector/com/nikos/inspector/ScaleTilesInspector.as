class com.nikos.inspector.ScaleTilesInspector extends com.nikos.inspector.TransitionInspector
{
	var rows,columns,overlap,ordering,rotate,reverse;
	var _line1, _line2, _line;
	var	FX_LIBRARY_NAME = "ScaleTiles";
	var	FX_NAME = "ScaleTiles";
	function ScaleTilesInspector()
    {
        super();
    } // End of the function
    ...
    function buildInspector()
    {
        ...
        _stageChangeListener.push(_line1);
        rows = /*(com.nikos.inspector.components.FFNumberInput)*/(_contentContainer_mc.attachMovie("ffNumberInput_mc", "number_input2_mc", _contentContainer_mc.getNextHighestDepth()));
        rows.init(this, "rows", xch.rows, "Rows: ", "", 1, 500, false);
        rows._x = com.nikos.inspector.TransitionInspector.RASTER;
		rows._y = _line1._y + _line1._height + com.nikos.inspector.TransitionInspector.RASTER;
        columns = /*(com.nikos.inspector.components.FFNumberInput)*/(_contentContainer_mc.attachMovie("ffNumberInput_mc", "number_input3_mc", _contentContainer_mc.getNextHighestDepth()));
        columns.init(this, "columns", xch.columns, "Columns: ", "", 1, 500, false);
        columns._x = com.nikos.inspector.TransitionInspector.RASTER;
        columns._y = rows._y + rows._height + com.nikos.inspector.TransitionInspector.RASTER;
        ...
        overlap._y = columns._y + columns._height + com.nikos.inspector.TransitionInspector.RASTER;
        ...
        ordering._y = overlap._y + overlap._height + com.nikos.inspector.TransitionInspector.RASTER;
        rotate = /*(com.nikos.inspector.components.FFRadioButtons)*/(_contentContainer_mc.attachMovie("ffRadioButtons_mc", "radioButtons2_mc", _contentContainer_mc.getNextHighestDepth()));
        rotate.init(this, "rotate", xch.rotate, "Rotate: ");
        rotate._x = com.nikos.inspector.TransitionInspector.RASTER;
        rotate._y = ordering._y + ordering._height + com.nikos.inspector.TransitionInspector.RASTER;
        reverse = /*(com.nikos.inspector.components.FFRadioButtons)*/(_contentContainer_mc.attachMovie("ffRadioButtons_mc", "radioButtons3_mc", _contentContainer_mc.getNextHighestDepth()));
        reverse.init(this, "reverse", xch.reverse, "Reverse: ");
        reverse._x = com.nikos.inspector.TransitionInspector.RASTER;
        reverse._y = rotate._y + rotate._height + com.nikos.inspector.TransitionInspector.RASTER;
        _line2 = this.drawLine("line2_mc", com.nikos.inspector.TransitionInspector.RASTER, Math.round(reverse._y + reverse._height + com.nikos.inspector.TransitionInspector.RASTER));
