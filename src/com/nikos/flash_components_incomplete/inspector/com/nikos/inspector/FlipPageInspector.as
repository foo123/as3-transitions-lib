class com.nikos.inspector.FlipPageInspector extends com.nikos.inspector.TransitionInspector
{
	var mode;
	var _line1, _line2, _line;
	var	FX_LIBRARY_NAME = "FlipPage";
	var	FX_NAME = "FlipPage";
	function FlipPageInspector()
    {
        super();
    } // End of the function
    ...
    function buildInspector()
    {
        ...
        mode.init(this, "mode", xch.mode, "Mode: ", ["horizontal-top-left","horizontal-top-right","horizontal-bottom-right","horizontal-bottom-left","vertical-top-left","vertical-top-right","vertical-bottom-left","vertical-bottom-right","horizontal-top-left-reverse","horizontal-top-right-reverse","horizontal-bottom-right-reverse","horizontal-bottom-left-reverse","vertical-top-left-reverse","vertical-top-right-reverse","vertical-bottom-left-reverse","vertical-bottom-right-reverse","diagonal-top-right-reverse","diagonal-bottom-right-reverse","diagonal-bottom-left-reverse","diagonal-top-left-reverse","diagonal-top-right","diagonal-bottom-right","diagonal-bottom-left","diagonal-top-left"]);
        mode._x = com.nikos.inspector.TransitionInspector.RASTER;
        mode._y = _line1._y + _line1._height + com.nikos.inspector.TransitionInspector.RASTER;
        _line2 = this.drawLine("line2_mc", com.nikos.inspector.TransitionInspector.RASTER, Math.round(mode._y + mode._height + com.nikos.inspector.TransitionInspector.RASTER));
