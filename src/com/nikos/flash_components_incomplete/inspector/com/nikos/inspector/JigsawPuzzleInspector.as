class com.nikos.inspector.JigsawPuzzleInspector extends com.nikos.inspector.TransitionInspector
{
	var overlap,ordering,mode;
	var _line1, _line2, _line;
	var	FX_LIBRARY_NAME = "JigsawPuzzle";
	var	FX_NAME = "JigsawPuzzle";
	function JigsawPuzzleInspector()
    {
        super();
    } // End of the function
    ...
    function buildInspector()
    {
        ...
        overlap._y = _line1._y + _line1._height + com.nikos.inspector.TransitionInspector.RASTER;
        ...
        mode.init(this, "mode", xch.mode, "Mode: ", ["random-move","center-move","swap","rotate","scale"]);
