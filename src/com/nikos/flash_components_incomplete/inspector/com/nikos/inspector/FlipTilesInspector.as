class com.nikos.inspector.FlipTilesInspector extends com.nikos.inspector.TransitionInspector
{
	var rows,columns,overlap,ordering,spin;
	var _line1, _line2, _line;
	var	FX_LIBRARY_NAME = "FlipTiles";
	var	FX_NAME = "FlipTiles";
	function FlipTilesInspector()
    {
        super();
    } // End of the function
    ...
    function buildInspector()
    {
        ...
        spin = /*(com.nikos.inspector.components.FFSelectList)*/(_contentContainer_mc.attachMovie("ffSelectList_mc", "ffSelectList4_mc", _contentContainer_mc.getNextHighestDepth()));
        spin.init(this, "spin", xch.spin, "Spin: ", ["horizontal","vertical"]);
        spin._x = com.nikos.inspector.TransitionInspector.RASTER;
        spin._y = overlap._y + overlap._height + com.nikos.inspector.TransitionInspector.RASTER;
        ...
        ordering._y = spin._y + spin._height + com.nikos.inspector.TransitionInspector.RASTER;
