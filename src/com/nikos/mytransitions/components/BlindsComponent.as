...
{ 
	...
	public class BlindsComponent extends TransitionComponent	
	{ 
		...
		[Inspectable (name = "mode", variable = "mode", type = "String", defaultValue = "left")]
		...
		private var _mode:String="left";
		
		public function BlindsComponent() 
		{
			super();
		} 
		...
		private function init(target1:DisplayObject,target2:DisplayObject):void
		{
			...
			{
				this._transition=new Blinds();
				Blinds.dispatch=true;
				Blinds.startNow=true;
				Blinds.persist=true;
				Blinds.useFrames=useFrames;
