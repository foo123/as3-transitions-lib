class com.nikos.inspector.ClockInspector extends com.nikos.inspector.TransitionInspector
{
	var segments,start_angle,clockwise;
	var _line1, _line2, _line;
	var	FX_LIBRARY_NAME = "Clock";
	var	FX_NAME = "Clock";
	function ClockInspector()
    {
        super();
    } // End of the function
    ...
    function buildInspector()
    {
        ...
        _stageChangeListener.push(_line1);
        segments = /*(com.nikos.inspector.components.FFNumberInput)*/(_contentContainer_mc.attachMovie("ffNumberInput_mc", "number_input2_mc", _contentContainer_mc.getNextHighestDepth()));
        segments.init(this, "segments", xch.segments, "Segments: ", "", 1, 500, false);
        segments._x = com.nikos.inspector.TransitionInspector.RASTER;
		segments._y = _line1._y + _line1._height + com.nikos.inspector.TransitionInspector.RASTER;
        start_angle = /*(com.nikos.inspector.components.FFNumberInput)*/(_contentContainer_mc.attachMovie("ffNumberInput_mc", "number_input3_mc", _contentContainer_mc.getNextHighestDepth()));
        start_angle.init(this, "start_angle", xch.start_angle, "Start Angle: ", "", -180, 180, false);
        start_angle._x = com.nikos.inspector.TransitionInspector.RASTER;
        start_angle._y = segments._y + segments._height + com.nikos.inspector.TransitionInspector.RASTER;
        clockwise = /*(com.nikos.inspector.components.FFRadioButtons)*/(_contentContainer_mc.attachMovie("ffRadioButtons_mc", "radioButtons1_mc", _contentContainer_mc.getNextHighestDepth()));
        clockwise.init(this, "clockwise", xch.clockwise, "Clockwise: ");
        clockwise._x = com.nikos.inspector.TransitionInspector.RASTER;
        clockwise._y = start_angle._y + start_angle._height + com.nikos.inspector.TransitionInspector.RASTER;
        _line2 = this.drawLine("line2_mc", com.nikos.inspector.TransitionInspector.RASTER, Math.round(clockwise._y + clockwise._height + com.nikos.inspector.TransitionInspector.RASTER));
