class com.nikos.inspector.DissolveInspector extends com.nikos.inspector.TransitionInspector
{
	var _line1, _line2, _line;
	var	FX_LIBRARY_NAME = "Dissolve";
	var	FX_NAME = "Dissolve";
	function DissolveInspector()
    {
        super();
    } // End of the function
