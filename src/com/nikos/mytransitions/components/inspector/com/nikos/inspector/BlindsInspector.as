class com.nikos.inspector.BlindsInspector extends com.nikos.inspector.TransitionInspector
{
	var rows,columns,overlap,ordering,mode;
	var _line1, _line2, _line;
	var	FX_LIBRARY_NAME = "Blinds";
	var	FX_NAME = "Blinds";
	function BlindsInspector()
    {
        super();
    } // End of the function
    ...
    function buildInspector()
    {
        ...
        mode = /*(com.nikos.inspector.components.FFSelectList)*/(_contentContainer_mc.attachMovie("ffSelectList_mc", "ffSelectList4_mc", _contentContainer_mc.getNextHighestDepth()));
        mode.init(this, "mode", xch.mode, "Mode: ", ["left","right","top","bottom","center","bottom-left","bottom-right","top-left","top-right"]);
        mode._x = com.nikos.inspector.TransitionInspector.RASTER;
        mode._y = overlap._y + overlap._height + com.nikos.inspector.TransitionInspector.RASTER;
        ...
        ordering._y = mode._y + mode._height + com.nikos.inspector.TransitionInspector.RASTER;
