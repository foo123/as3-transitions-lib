class com.nikos.inspector.FadeTilesInspector extends com.nikos.inspector.TransitionInspector
{
	var rows,columns,overlap,ordering;
	var _line1, _line2, _line;
	var	FX_LIBRARY_NAME = "FadeTiles";
	var	FX_NAME = "FadeTiles";
	function FadeTilesInspector()
    {
        super();
    } // End of the function
