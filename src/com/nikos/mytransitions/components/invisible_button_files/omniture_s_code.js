...
/* Set Report Suite ID */
if (!window.s_accountName && !window.s_account) { 
	if (s_Host.indexOf("cps-internal.corp") != -1) var s_account="mxcpsinternal";
	else if ((s_Host.indexOf(".dev.adobe.") != -1) || (s_Host.indexOf(".sflab.acrobat.") != -1) || (s_Host.indexOf("stage.") != -1) || (s_Host.indexOf("staging.") != -1) || (s_Host.indexOf(".sea.adobe") != -1) || (s_Host.indexOf(".corp.adobe") != -1)) var s_account="mxadobetest";
	else if (s_Host.indexOf("createpdf.acrobat.com") != -1) var s_account="mxmacromedia,mxcreatepdf";
	else if (s_Host.indexOf("formscentral.acrobat.com") != -1) var s_account="mxmacromedia,mxformscentral";
	else if (s_Host.indexOf("sendnow.acrobat.com") != -1) var s_account="mxmacromedia,mxsendnow";
	else if (s_Host.indexOf("acrobat.com") != -1) var s_account="mxmacromedia,mxacrobatdotcom";
	else if (s_Host.indexOf("kuler.adobe") != -1) var s_account="mxmacromedia,mxkuler";	
	else var s_account="mxmacromedia";
...
if (s.c_r("adobe_optout")!=1 && s_URL.indexOf("/misc/optout")==-1) {
/* Eloqua Integration */	
var s_checkElq=/(success.adobe.com)|(adobe.com\/media)|(adobe.com\/education)|(adobe.com\/enterprise)|(adobe.com\/financial)|(adobe.com\/government)(adobe.com\/lifesciences)|(adobe.com\/manufacturing)|(adobe.com\/products\/acrobat)|(adobe.com\/products\/creativesuite)|(adobe.com\/flashplatform)|(adobe.com\/products\/livecycle)|(adobe.com\/products\/adobeconnect)|(adobe.com\/solutions)|(adobe.com\/uk\/solutions)|(adobe.com\/fr\/solutions)|(adobe.com\/de\/solutions)|(adobe.com\/no\/solutions)|(adobe.com\/se\/solutions)|(adobe.com\/dk\/solutions)|(adobe.com\/fi\/solutions)|(adobe.com\/nl\/solutions)|(adobe.com\/be_fr\/solutions)|(adobe.com\/ch_fr\/solutions)|(adobe.com\/ch_de\/solutions)|(adobe.com\/at\/solutions)|(adobe.com\/uk\/products\/adobeconnect)|(adobe.com\/fr\/products\/adobeconnect)|(adobe.com\/de\/products\/adobeconnect)|(adobe.com\/no\/products\/adobeconnect)|(adobe.com\/se\/products\/adobeconnect)|(adobe.com\/dk\/products\/adobeconnect)|(adobe.com\/fi\/products\/adobeconnect)|(adobe.com\/nl\/products\/adobeconnect)|(adobe.com\/be_fr\/products\/adobeconnect)|(adobe.com\/ch_fr\/products\/adobeconnect)|(adobe.com\/ch_de\/products\/adobeconnect)|(adobe.com\/at\/products\/adobeconnect)|(adobe.com\/opengov)|(adobe.com\/aboutadobe\/openoptions)|(\/acom\/connectnow)|(adobe.com\/products\/reader\/rdr_distribution)|(devnet\/acrobat\/sdk)|(adobe.com\/opengov)|(adobe.com\/devnet-archive\/acrobatconnect)|(blogs.adobe.com\/adobeingovernment)|(adobe.com\/products\/eula\/livecycle\/es\/trial)|(adobe.com\/security\/partners)|(adobe.com\/support\/connect)|(adobe.com\/support\/programs\/connect)|(adobe.com\/products\/adobeconnect.html)|(partners.adobe.com\/resellerfinder\/na\/)/gi;
var s_matchElq = window.s_URL.search(s_checkElq);
// Check Other Areas including Dylan Forms RFI and Events
if (s_matchElq < 1) {
...
/* Excluding Polar Bear, load TNT and Demandbase */
var s_checkTnT=/^http:\/\/get/gi;
	var s_matchTnT = window.s_URL.search(s_checkTnT);
	if (s_matchTnT<0 && (s_URL.indexOf("/flash/about") == -1) && (s_URL.indexOf("blogs.adobe") == -1)) {
		s_matchTnT=-1;
		if(typeof(window['mboxVersion']) == "undefined") {
			if (s_Host.indexOf(".corp.adobe") != -1 || s_Host.indexOf("uqa01.adobe") != -1 || s_Host.indexOf("stage.") != -1 || s_Host.indexOf(".dev.adobe") != -1 || s_Host.indexOf("staging.") != -1)
				document.write(unescape("%3Cscript src='" + "/uber/js/omniture/mbox.js' type='text/javascript'%3E%3C/script%3E"));
			else
				document.write(unescape("%3Cscript src='" + s_JsHost + "/uber/js/omniture/mbox.js' type='text/javascript'%3E%3C/script%3E")); 
		}		
...
var c={},d=this.conf.data_mapping;if(b.demandbase_sid){if(d.company)c[d.company]=b.company_name;if(d.industry)c[d.industry]=b.industry+"::"+b.sub_industry;if(d.employee_range)c[d.employee_range]=b.employee_range;
...
if (s_matchDylan != -1)	s.server="Dylan";
...
function s_doPlugins(s) {
  ...
  if (typeof(s_prop32)!=="undefined" && s_prop32.indexOf('ad_') == 0) {
	  s_prop32=s_prop32.replace(/US$|CA$/,"");	
	  s.prop32=s_prop32=s_prop32.replace("_en","_us");  
      ...
      if (typeof(s_pageName)!=="undefined" && s_pageName.indexOf("ad_")==0) {
		...
		s.pageName=s_pageName=s_pageName.replace(/STE_/,"");
	    s.pageName=s_pageName=s_pageName.replace("_en_","_us_");
	  }
	  if (typeof(s_prop52)!=="undefined" && s_prop52.indexOf("ad_")==0) { 
		s_prop52=s_prop52.replace(/US_|CA_/,"_");
	    s.prop52=s_prop52=s_prop52.replace(/STE$/,"");
		s.prop52=s_prop52=s_prop52.replace("_en_","_us_");
	  }
	  if (typeof(s_products)!=="undefined" && s_products.indexOf(";")!=-1) {
	    s.products=s_products=s_products.replace(/STE;/g,";");
	    s.products=s_products=s_products.replace(/;Tax;/i,";;");
		s.products=s_products=s_products.replace(/;eVar20=Tax/i,";");
	    s.products=s_products=s_products.replace(/;Shipping;/i,";;");
	    s.products=s_products=s_products.replace(/;eVar20=Shipping/i,";");
	  }
  }
  if ((window.s_account=="mxmacromedia") && typeof(s_pageName)!=="undefined" && s_pageName.indexOf('ad_') == 0) {
	  	if(s_pageName.indexOf("photoshopfamilyFamily")!=-1) {
		  s.pageName=s_pageName=s_pageName.replace("photoshopfamilyFamily","PhotoshopFamily");
		  s.channel=s_channel=s_channel.replace("photoshopfamilyFamily","PhotoshopFamily");
		  s.prop52=s_prop52=s_prop52.replace("photoshopfamilyFamily","PhotoshopFamily");
		  s.products=s_products=s_products.replace(/photoshopfamilyFamily/g,"PhotoshopFamily");
		}
		else if (s_pageName.indexOf("creativesuiteFamily")!=-1) {
		...
		else if (s_pageName.indexOf("elements-familyFamily")!=-1) {
		  s.pageName=s_pageName=s_pageName.replace("elements-familyFamily","ElementsFamily");
		  s.channel=s_channel=s_channel.replace("elements-familyFamily","ElementsFamily");
		  s.prop52=s_prop52=s_prop52.replace("elements-familyFamily","ElementsFamily");
		  s.products=s_products=s_products.replace(/elements-familyFamily/g,"ElementsFamily");
		}
		...
		var s_pageNameprod=s_splitpageName[s_splitpageName.length-2];
		var s_pageNamefile=s_splitpageName[s_splitpageName.length-1];
	  	if (s_pageNamefile.indexOf(".")!=-1) s_pageNamefile=s_pageNamefile.replace(/\.(.*)/,""); // strip file extension
		if (s_pageNameprod==s_pageNamefile) {
			var s_URLprod=window.s_URL.substring(s_URL.indexOf("/products/")+9); // Get product from URL
	  		s_splitURL=s_URLprod.split('/');
			if (s_URL.indexOf(".com/products/creativesuite")==-1 && (s_URL.indexOf("/products/creativesuite/web")!=-1 || s_URL.indexOf("/products/creativesuite/design")!=-1)) {
				/* For Localized WP, DP, DS variable issues */
				s_URLprod=s_splitURL[2];
				if(s_URLprod.indexOf(".")!=-1) s_URLprod = s_URLprod.replace(/\.(.*)/,""); // strip file extension;
				if(s_URLprod=='design') s_URLprod='DesignPremium';
	  			else if(s_URLprod=='designstandard') s_URLprod='DesignStandard';
	  			else if (s_URLprod=='web') s_URLprod='WebPremium';
				s.products=s_products=";"+s_URLprod+";;;;evar26=site|evar27="+s_pageName;
			...
			else if (s_URL.indexOf("/products/elements-family/")!=-1 || s_URL.indexOf("/products/acrobat/")!= -1 || s_URL.indexOf("/products/creativesuite/")!= -1 || s_URL.indexOf("/products/photoshopfamily/")!= -1 || s_URL.indexOf("/products/elearningsuite/")!=-1){
				// For Family Pages Deep Page Issues */
				if(s_URL.indexOf("/products/photoshopfamily/")!=-1) s_URLprod='PhotoshopFamily';
				else if (s_URL.indexOf("/products/creativesuite/")!=-1) s_URLprod='CreativeSuiteFamily';
				else if (s_URL.indexOf("/products/acrobat/")!=-1) s_URLprod='AcrobatFamily';
				else if (s_URL.indexOf("/products/elements-family/")!=-1) s_URLprod='ElementsFamily';		
				s_URLprod=s_splitURL[1];
				if(s_URLprod.indexOf(".")!=-1) s_URLprod = s_URLprod.replace(/\.(.*)/,""); // strip file extension;
...
if (typeof(s_omtrProd)!=="undefined") {
	if(s_omtrProd.indexOf(";")!= -1 && s_pageName.indexOf('ad_')==0) {
		if(s_events=="prodView") {
			if (s_products.indexOf("Family")!=-1) s.products=s_products=s_products.replace(/eVar27=([^,]*)/g,'eVar27='+s_pageName);
			else s.products=s_products=s_omtrProd.replace(/eVar27=([^,]*)/g,'eVar27='+s_pageName);
			s.products=s_products=s_products.replace(/STE;/g,";");
  ...
  /* TNT Plugin */
  if (s.c_r("adobe_optout")!=1 && s_URL.indexOf("/misc/optout")==-1 && s_matchTnT<0) {
	mboxLoadSCPlugin(s);
	s.tnt=s.trackTNT(); 
  }
}
...
+"Var70';s.Integrate.SocialAuthor.get('http://search.twitter.com/sear"
