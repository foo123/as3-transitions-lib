...
}(function(){if(window!=window.top){}function G(K){if(typeof K=="object"){var J=K.constructor.toString().match(/array/i);
...
},execute:function(D,E){if(!FSR.enabled){return }var B=this;if(this.isloaded){var A=new Date().getTime();
